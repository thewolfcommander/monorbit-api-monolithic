    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(blank=True, default=datetime.datetime(2020, 8, 11, 23, 23, 2, 397687), null=True)),
                ('created', models.DateTimeField(blank=True, default=datetime.datetime(2020, 8, 11, 22, 23, 2, 397812), null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(blank=True, default=datetime.datetime(2020, 8, 11, 22, 53, 2, 399783), null=True)),
                ('created', models.DateTimeField(blank=True, default=datetime.datetime(2020, 8, 11, 22, 23, 2, 399894), null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
