...
class Order(models.Model):
    ...
    billing_address = models.ForeignKey(Address, on_delete=models.DO_NOTHING, related_name="billing_address", help_text="Reference to the Address added by the user. This will be used as billing address for the user")
